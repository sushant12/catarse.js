...
var projectDashboardMenu = {
    controller: function controller(args) {
        var body = document.getElementsByTagName('body')[0],
            ...
            m.request({
                ...
                validating(false);
                railsErrorsVM$1.setRailsErrors(err.errors_json);
                m.redraw();
            });
        },
    ...
    view: function view(ctrl, args) {
        ...
        }, [m('span.fa.fa-pencil.fa-fw.fa-lg'), I18n$1.t('edit_project', I18nScope$7())]), ctrl.editLinksToggle() ? m('#edit-menu-items', [m('#dashboard-links', [!project.is_published || project.is_admin_role ? [m('a#basics_link[class="' + editLinkClass('#basics') + '"][href="' + editRoute + '#basics"]', railsErrorsVM$1.errorsFor('basics'), I18n$1.t('basics_tab', linksScope())), m('a#goal_link[class="' + editLinkClass('#goal') + '"][href="' + editRoute + '#goal"]', railsErrorsVM$1.errorsFor('goal'), I18n$1.t('goal_tab', linksScope()))] : '', m('a#description_link[class="' + editLinkClass('#description') + '"][href="' + editRoute + '#description"]', railsErrorsVM$1.errorsFor('description'), I18n$1.t('description_tab', linksScope())), m('a#video_link[class="' + editLinkClass('#video') + '"][href="' + editRoute + '#video"]', [railsErrorsVM$1.errorsFor('video'), 'Video', m('span.fontsize-smallest.fontcolor-secondary', ' (optinal)')]), m('a#budget_link[class="' + editLinkClass('#budget') + '"][href="' + editRoute + '#budget"]', railsErrorsVM$1.errorsFor('budget'), I18n$1.t('budget_tab', linksScope())), m('a#card_link[class="' + editLinkClass('#card') + '"][href="' + editRoute + '#card"]', railsErrorsVM$1.errorsFor('card'), I18n$1.t('card_tab', linksScope())), m('a#dashboard_reward_link[class="' + editLinkClass('#reward') + '"][href="' + editRoute + '#reward"]', [railsErrorsVM$1.errorsFor('reward'), 'Rewards', optionalOpt]), m('a#dashboard_user_about_link[class="' + editLinkClass('#user_about') + '"][href="' + editRoute + '#user_about"]', railsErrorsVM$1.errorsFor('user_about'), I18n$1.t('about_you_tab', linksScope())), project.is_published || project.state === 'draft' || project.is_admin_role ? [m('a#dashboard_user_settings_link[class="' + editLinkClass('#user_settings') + '"][href="' + editRoute + '#user_settings"]', railsErrorsVM$1.errorsFor('user_settings'), I18n$1.t('account_tab', linksScope()))] : '', !project.is_published ? [m('a#dashboard_preview_link[class="' + editLinkClass('#preview') + '"][href="' + editRoute + '#preview"]', [m('span.fa.fa-fw.fa-eye.fa-lg'), I18n$1.t('preview_tab', linksScope())])] : ''])]) : '', !project.is_published && ctrl.showPublish() ? [ctrl.validating() ? h.loader() : m('.btn-send-draft-fixed', project.mode === 'aon' ? [project.state === 'draft' ? m('button.btn.btn-medium', {
    ...
    view: function view(ctrl, args) {
        var project = args.project,
            ...
            var states = {
                ...
                failed: I18n$1.t('display_status.failed', I18nScope$19({ date: h.momentify(project().zone_expires_at), goal: 'R$ ' + h.formatNumber(project().goal, 2, 3) })),
...
var userAboutEdit = {
    controller: function controller(args) {
        var parsedErrors = userAboutVM.mapRailsErrors(railsErrorsVM$1.railsErrors());
        ...
        var user = args.user || {},
            ...
            return m.request({
                ...
                loading(false);
                m.redraw();
                railsErrorsVM$1.validatePublish();
            }).catch(function (err) {
                if (parsedErrors) {
...
var userSettings = {
    controller: function controller(args) {
        var parsedErrors = userSettingsVM.mapRailsErrors(railsErrorsVM$1.railsErrors());
        var deleteFormSubmit = void 0;
        var user = args.user,
            fields = {
    ...
    controller: function controller(args) {
        var vm = projectGoalVM,
            ...
            vm.updateProject(args.projectId).then(function (data) {
                ...
                if (err.errors_json) {
                    railsErrorsVM$1.mapRailsErrors(err.errors_json, mapErrors, vm.e);
                }
                loading(false);
                if (showSuccess()) {
                    showSuccess.toggle();
        ...
        if (railsErrorsVM$1.railsErrors()) {
            railsErrorsVM$1.mapRailsErrors(railsErrorsVM$1.railsErrors(), mapErrors, vm.e);
        }
        ...
        var vm = projectCardVM,
            ...
            vm.uploadImage(args.projectId).then(function (uploaded) {
                ...
                if (uploaderr.errors_json) {
                    railsErrorsVM$1.mapRailsErrors(uploaderr.errors_json, mapErrors, vm.e);
                }
                loading(false);
                if (showSuccess()) {
                    showSuccess.toggle();
...
var footer = {
    view: function view() {
        ...
        //     ' Grasruts flex'
        // ),
        m('a.link-footer[href=\'/team?ref=ctrse_footer\']', [I18n$1.t('links.team', I18nScope$49()), m.trust(' &lt;'), '3']), m('a.link-footer[href=\'https://www.facebook.com/grasruts\'][target=\'__blank\']', ' Facebook'), m('a.link-footer[href=\'https://twitter.com/grasruts\'][target=\'__blank\']', ' Twitter'), m('a.link-footer[href=\'http://instagram.com/the_grasruts/\'][target=\'__blank\']', ' Instagram'), m('a.link-footer[href=\'https://www.pinterest.com/grasruts\'][target=\'__blank\']', ' Pinterest'), m('a.link-footer[href=\'https://github.com/sushant12/jvn\'][target=\'__blank\']', ' Github'), m('a.link-footer[href=\'https://medium.com/grasruts\'][target=\'__blank\']', ' Blog'), m('a.link-footer[href=\'/jobs?ref=ctrse_footer\']', I18n$1.t('links.jobs', I18nScope$49()))]), m('.w-col.w-col-4.w-col-small-4.w-col-tiny-4.footer-full-firstcolumn', [m('.footer-full-signature-text.fontsize-small', I18n$1.t('titles.about', I18nScope$49())), m('a.link-footer[href=\'#?ref=ctrse_footer\']', [I18n$1.t('links.how_it_works', I18nScope$49()), m.trust('&nbsp;')]), m('a.link-footer[href=\'https://grasruts.zendesk.com/hc/en-us/requests/new\'][target="_BLANK"]', I18n$1.t('links.contact', I18nScope$49())),
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
